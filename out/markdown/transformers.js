...
var and__6047__auto__ = cljs.core.not_empty.call(null,trimmed);
...
if(cljs.core.truth_((function (){var or__6059__auto__ = new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_((function (){var or__6059__auto__ = markdown.transformers.h1_QMARK_.call(null,text);
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
...
var G__14452 = cljs.core.into.call(null,buf,cljs.core.concat.call(null,cljs.core.seq.call(null,"<sup>"),cljs.core.second.call(null,remaining),cljs.core.seq.call(null,"</sup>")));
var G__14453 = cljs.core.drop.call(null,(2),remaining);
buf = G__14452;
remaining = G__14453;
continue;
} else {
var G__14454 = cljs.core.into.call(null,buf,cljs.core.first.call(null,remaining));
var G__14455 = cljs.core.rest.call(null,remaining);
buf = G__14454;
remaining = G__14455;
continue;
...
if(cljs.core.truth_((function (){var or__6059__auto__ = new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
...
markdown.transformers.br = (function markdown$transformers$br(text,p__14456){
var map__14459 = p__14456;
var map__14459__$1 = ((((!((map__14459 == null)))?((((map__14459.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14459.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14459):map__14459);
var state = map__14459__$1;
var code = cljs.core.get.call(null,map__14459__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var lists = cljs.core.get.call(null,map__14459__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [" "," "], null),cljs.core.take_last.call(null,(2),text))) && (cljs.core.not.call(null,(function (){var or__6059__auto__ = code;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
return lists;
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(cljs.core.truth_(new cljs.core.Keyword(null,"code","code",1586293142).cljs$core$IFn$_invoke$arity$1(state))?text:clojure.string.replace.call(null,text,/<https?:\/\/[-A-Za-z0-9+&@#\/%?=~_()|!:,.;]*[-A-Za-z0-9+&@#\/%=~_()|]>/,(function (p1__14461_SHARP_){
var url = cljs.core.subs.call(null,p1__14461_SHARP_,(1),(cljs.core.count.call(null,p1__14461_SHARP_) - (1)));
...
})())?text:clojure.string.replace.call(null,text,/<[\w._%+-]+@[\w.-]+\.[\w]{2,4}>/,(function (p1__14462_SHARP_){
var encoded = (cljs.core.truth_(new cljs.core.Keyword(null,"clojurescript","clojurescript",-299769403).cljs$core$IFn$_invoke$arity$1(state))?cljs.core.subs.call(null,p1__14462_SHARP_,(1),(cljs.core.count.call(null,p1__14462_SHARP_) - (1))):cljs.core.apply.call(null,cljs.core.str,cljs.core.map.call(null,(function (c){
if((cljs.core.rand.call(null) > 0.5)){
return markdown.transformers.formatter.call(null,"&#x%02x;",(c | (0)));
} else {
return c;
}
}),cljs.core.subs.call(null,p1__14462_SHARP_,(1),(cljs.core.count.call(null,p1__14462_SHARP_) - (1))))));
return [cljs.core.str("<a href=\"mailto:"),cljs.core.str(encoded),cljs.core.str("\">"),cljs.core.str(encoded),cljs.core.str("</a>")].join('');
}))),state], null);
});
markdown.transformers.set_line_state = (function markdown$transformers$set_line_state(text,p__14463){
var map__14466 = p__14463;
var map__14466__$1 = ((((!((map__14466 == null)))?((((map__14466.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14466.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14466):map__14466);
var state = map__14466__$1;
var inline_heading = cljs.core.get.call(null,map__14466__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
...
if(cljs.core.truth_((function (){var and__6047__auto__ = cljs.core.not.call(null,last_line_empty_QMARK_);
...
markdown.transformers.paragraph = (function markdown$transformers$paragraph(text,p__14468){
var map__14471 = p__14468;
var map__14471__$1 = ((((!((map__14471 == null)))?((((map__14471.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14471.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14471):map__14471);
var state = map__14471__$1;
var eof = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var paragraph__$1 = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"paragraph","paragraph",296707709));
var blockquote = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"blockquote","blockquote",372264190));
var heading = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"heading","heading",-1312171873));
var hr = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"hr","hr",1377740067));
var temp = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"temp","temp",1791541284));
var lists = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var inline_heading = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var code = cljs.core.get.call(null,map__14471__$1,new cljs.core.Keyword(null,"code","code",1586293142));
if(cljs.core.truth_((function (){var and__6047__auto__ = paragraph__$1;
if(cljs.core.truth_(and__6047__auto__)){
return lists;
} else {
return and__6047__auto__;
...
if(cljs.core.truth_((function (){var or__6059__auto__ = heading;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
var or__6059__auto____$1 = inline_heading;
if(cljs.core.truth_(or__6059__auto____$1)){
return or__6059__auto____$1;
} else {
var or__6059__auto____$2 = hr;
if(cljs.core.truth_(or__6059__auto____$2)){
return or__6059__auto____$2;
} else {
var or__6059__auto____$3 = code;
if(cljs.core.truth_(or__6059__auto____$3)){
return or__6059__auto____$3;
} else {
var or__6059__auto____$4 = lists;
if(cljs.core.truth_(or__6059__auto____$4)){
return or__6059__auto____$4;
} else {
return blockquote;
}
}
...
if(cljs.core.truth_((function (){var or__6059__auto__ = eof;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
...
if(cljs.core.truth_((function (){var and__6047__auto__ = cljs.core.not.call(null,eof);
if(and__6047__auto__){
var and__6047__auto____$1 = !(clojure.string.blank_QMARK_.call(null,text));
if(and__6047__auto____$1){
var or__6059__auto__ = new cljs.core.Keyword(null,"inline-heading","inline-heading",-158773818).cljs$core$IFn$_invoke$arity$1(temp);
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
...
markdown.transformers.code = (function markdown$transformers$code(text,p__14473){
var map__14476 = p__14473;
var map__14476__$1 = ((((!((map__14476 == null)))?((((map__14476.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14476.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14476):map__14476);
var state = map__14476__$1;
var eof = cljs.core.get.call(null,map__14476__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__14476__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var code__$1 = cljs.core.get.call(null,map__14476__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__14476__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
if(cljs.core.truth_((function (){var or__6059__auto__ = lists;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
return codeblock;
...
if(cljs.core.truth_((function (){var and__6047__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take.call(null,(3),trimmed));
if(and__6047__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__6047__auto__;
...
if(cljs.core.truth_((function (){var and__6047__auto__ = cljs.core._EQ_.call(null,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, ["`","`","`"], null),cljs.core.take_last.call(null,(3),trimmed));
if(and__6047__auto__){
return new cljs.core.Keyword(null,"codeblock","codeblock",-851153855).cljs$core$IFn$_invoke$arity$1(state);
} else {
return and__6047__auto__;
...
var vec__14481 = cljs.core.split_with.call(null,cljs.core.partial.call(null,cljs.core.not_EQ_," "),cljs.core.drop.call(null,(3),trimmed));
var lang = cljs.core.nth.call(null,vec__14481,(0),null);
var code = cljs.core.nth.call(null,vec__14481,(1),null);
...
markdown.transformers.blockquote = (function markdown$transformers$blockquote(text,p__14484){
var map__14487 = p__14484;
var map__14487__$1 = ((((!((map__14487 == null)))?((((map__14487.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14487.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14487):map__14487);
var state = map__14487__$1;
var eof = cljs.core.get.call(null,map__14487__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var code = cljs.core.get.call(null,map__14487__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__14487__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var lists = cljs.core.get.call(null,map__14487__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
var trimmed = clojure.string.trim.call(null,text);
if(cljs.core.truth_((function (){var or__6059__auto__ = code;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
var or__6059__auto____$1 = codeblock;
if(cljs.core.truth_(or__6059__auto____$1)){
return or__6059__auto____$1;
} else {
return lists;
...
return [cljs.core.str("<ol class='footnotes'>"),cljs.core.str(p1__14489_SHARP_),cljs.core.str("</ol>")].join('');
}).call(null,cljs.core.reduce.call(null,(function (footnotes__$1,p__14494){
var vec__14495 = p__14494;
var id = cljs.core.nth.call(null,vec__14495,(0),null);
var label = cljs.core.nth.call(null,vec__14495,(1),null);
...
var vec__14504 = cljs.core.re_matches.call(null,/^([0-9A-Za-z_-]*):(.*)$/,line);
var _ = cljs.core.nth.call(null,vec__14504,(0),null);
var key = cljs.core.nth.call(null,vec__14504,(1),null);
var val = cljs.core.nth.call(null,vec__14504,(2),null);
var vec__14507 = cljs.core.re_matches.call(null,/^    (.*)$/,line);
var ___$1 = cljs.core.nth.call(null,vec__14507,(0),null);
var next_val = cljs.core.nth.call(null,vec__14507,(1),null);
...
var vec__14513 = ((cljs.core.sequential_QMARK_.call(null,data))?data:new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [prev_key,data], null));
var key = cljs.core.nth.call(null,vec__14513,(0),null);
var val = cljs.core.nth.call(null,vec__14513,(1),null);
...
var G__14516 = cljs.core.merge.call(null,acc,cljs.core.PersistentArrayMap.fromArray([key,new_val], true, false));
var G__14517 = cljs.core.rest.call(null,remain);
var G__14518 = key;
acc = G__14516;
remain = G__14517;
prev_key = G__14518;
