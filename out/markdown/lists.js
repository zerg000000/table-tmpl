...
return clojure.string.join.call(null,(function (){var iter__6839__auto__ = (function markdown$lists$close_lists_$_iter__14415(s__14416){
return (new cljs.core.LazySeq(null,(function (){
var s__14416__$1 = s__14416;
while(true){
var temp__4657__auto__ = cljs.core.seq.call(null,s__14416__$1);
if(temp__4657__auto__){
var s__14416__$2 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,s__14416__$2)){
var c__6837__auto__ = cljs.core.chunk_first.call(null,s__14416__$2);
var size__6838__auto__ = cljs.core.count.call(null,c__6837__auto__);
var b__14418 = cljs.core.chunk_buffer.call(null,size__6838__auto__);
if((function (){var i__14417 = (0);
while(true){
if((i__14417 < size__6838__auto__)){
var vec__14425 = cljs.core._nth.call(null,c__6837__auto__,i__14417);
var list_type = cljs.core.nth.call(null,vec__14425,(0),null);
cljs.core.chunk_append.call(null,b__14418,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''));

var G__14431 = (i__14417 + (1));
i__14417 = G__14431;
continue;
} else {
return true;
...
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14418),markdown$lists$close_lists_$_iter__14415.call(null,cljs.core.chunk_rest.call(null,s__14416__$2)));
} else {
return cljs.core.chunk_cons.call(null,cljs.core.chunk.call(null,b__14418),null);
}
} else {
var vec__14428 = cljs.core.first.call(null,s__14416__$2);
var list_type = cljs.core.nth.call(null,vec__14428,(0),null);
return cljs.core.cons.call(null,[cljs.core.str("</li></"),cljs.core.str(cljs.core.name.call(null,list_type)),cljs.core.str(">")].join(''),markdown$lists$close_lists_$_iter__14415.call(null,cljs.core.rest.call(null,s__14416__$2)));
}
} else {
return null;
}
...
return iter__6839__auto__.call(null,lists);
})());
});
...
var lists_to_close = cljs.core.take_while.call(null,(function (p1__14432_SHARP_){
return (cljs.core.second.call(null,p1__14432_SHARP_) > num_indents);
...
var vec__14436 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__14436,(0),null);
var indents = cljs.core.nth.call(null,vec__14436,(1),null);
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ul","ul",-1349521403),list_type,num_indents,indents,(function (){var or__6059__auto__ = markdown.common.make_heading.call(null,content,false);
...
var vec__14442 = cljs.core.last.call(null,new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.call(null,vec__14442,(0),null);
var indents = cljs.core.nth.call(null,vec__14442,(1),null);
var num_indents = cljs.core.count.call(null,cljs.core.take_while.call(null,cljs.core.partial.call(null,cljs.core._EQ_," "),text));
...
return markdown.lists.add_row.call(null,new cljs.core.Keyword(null,"ol","ol",932524051),list_type,num_indents,indents,(function (){var or__6059__auto__ = markdown.common.make_heading.call(null,content,false);
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
return content;
...
markdown.lists.li = (function markdown$lists$li(text,p__14445){
var map__14448 = p__14445;
var map__14448__$1 = ((((!((map__14448 == null)))?((((map__14448.cljs$lang$protocol_mask$partition0$ & (64))) || (map__14448.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__14448):map__14448);
var state = map__14448__$1;
var code = cljs.core.get.call(null,map__14448__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var codeblock = cljs.core.get.call(null,map__14448__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.call(null,map__14448__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.call(null,map__14448__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.call(null,map__14448__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
if(cljs.core.truth_((function (){var and__6047__auto__ = last_line_empty_QMARK_;
...
if(cljs.core.truth_((function (){var and__6047__auto__ = lists;
if(cljs.core.truth_(and__6047__auto__)){
var or__6059__auto__ = last_line_empty_QMARK_;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
return eof;
...
var and__6047__auto____$1 = lists;
...
if(cljs.core.truth_((function (){var and__6047__auto__ = (function (){var or__6059__auto__ = eof;
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
