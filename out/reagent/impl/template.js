...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__6665__auto__,writer__6666__auto__,opt__6667__auto__){
return cljs.core._write.call(null,writer__6666__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14999 = o;
(G__14999[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__6047__auto__ = cljs.core.some_QMARK_.call(null,reagent.impl.template.find_dom_node);
if(and__6047__auto__){
var and__6047__auto____$1 = cljs.core.some_QMARK_.call(null,jsprops);
if(and__6047__auto____$1){
var and__6047__auto____$2 = (jsprops["hasOwnProperty"])("onChange");
...
var G__15007 = jsprops;
(G__15007["defaultValue"] = value);

(G__15007["onChange"] = ((function (G__15007,v,value,on_change){
return (function (p1__15005_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__15005_SHARP_);
});})(G__15007,v,value,on_change))
);
...
var vec__15014 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__15014,(0),null);
var id = cljs.core.nth.call(null,vec__15014,(1),null);
var class$ = cljs.core.nth.call(null,vec__15014,(2),null);
...
var jsprops = {"argv": v};
var temp__4661__auto___15019 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___15019 == null)){
} else {
var key_15020 = temp__4661__auto___15019;
(jsprops["key"] = key_15020);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__15022 = (new reagent.impl.template.NativeWrapper());
(G__15022["name"] = c);
...
var len__7134__auto___15028 = arguments.length;
var i__7135__auto___15029 = (0);
while(true){
if((i__7135__auto___15029 < len__7134__auto___15028)){
args__7141__auto__.push((arguments[i__7135__auto___15029]));

var G__15030 = (i__7135__auto___15029 + (1));
i__7135__auto___15029 = G__15030;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__7142__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq15026){
var G__15027 = cljs.core.first.call(null,seq15026);
var seq15026__$1 = cljs.core.next.call(null,seq15026);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__15027,seq15026__$1);
});
...
break;
default:
var G__15034 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__15034;
continue;
...
var n__6974__auto___15037 = a.length;
var i_15038 = (0);
while(true){
if((i_15038 < n__6974__auto___15037)){
(a[i_15038] = reagent.impl.template.as_element.call(null,(a[i_15038])));

var G__15039 = (i_15038 + (1));
i_15038 = G__15039;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__6974__auto___15040 = a.length;
var i_15041 = (0);
while(true){
if((i_15041 < n__6974__auto___15040)){
var val_15042 = (a[i_15041]);
if((cljs.core.vector_QMARK_.call(null,val_15042)) && ((reagent.impl.template.key_from_vec.call(null,val_15042) == null))){
(o["no-key"] = true);
} else {
}

(a[i_15041] = reagent.impl.template.as_element.call(null,val_15042));

var G__15043 = (i_15041 + (1));
i_15041 = G__15043;
continue;
} else {
}
...
var ctx = {};
var vec__15047 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__15047,(0),null);
var derefed = cljs.core.nth.call(null,vec__15047,(1),null);
...
var G__15051 = (cljs.core.count.call(null,argv) - first_child);
switch (G__15051) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__15051){
