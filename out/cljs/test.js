...
var args13188 = [];
var len__7134__auto___13192 = arguments.length;
var i__7135__auto___13193 = (0);
while(true){
if((i__7135__auto___13193 < len__7134__auto___13192)){
args13188.push((arguments[i__7135__auto___13193]));

var G__13194 = (i__7135__auto___13193 + (1));
i__7135__auto___13193 = G__13194;
continue;
} else {
}
break;
...
var G__13191 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__13191,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__13191;
}
});
...
var or__6059__auto__ = cljs.test._STAR_current_env_STAR_;
...
var len__7134__auto___13199 = arguments.length;
var i__7135__auto___13200 = (0);
while(true){
if((i__7135__auto___13200 < len__7134__auto___13199)){
args__7141__auto__.push((arguments[i__7135__auto___13200]));

var G__13201 = (i__7135__auto___13200 + (1));
i__7135__auto___13200 = G__13201;
continue;
} else {
}
break;
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__7142__auto__);
});
...
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq13196){
...
return cljs.test.update_current_env_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__13197,G__13198,seq13196__$2);
});
...
var file = cljs.core.get.call(null,map__13205__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.call(null,map__13205__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__13205__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__13205,map__13205__$1,file,line,column){
return (function (p1__13202_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__13202_SHARP_));
});})(map__13205,map__13205__$1,file,line,column))
 ...
 */
cljs.test.report = (function (){var method_table__6984__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
return (new cljs.core.MultiFn(cljs.core.symbol.call(null,"cljs.test","report"),((function (method_table__6984__auto__,prefer_table__6985__auto__,method_cache__6986__auto__,cached_hierarchy__6987__auto__,hierarchy__6988__auto__){
return (function (m){
...
var formatter_fn = (function (){var or__6059__auto__ = new cljs.core.Keyword(null,"formatter","formatter",-483008823).cljs$core$IFn$_invoke$arity$1(cljs.test.get_current_env.call(null));
if(cljs.core.truth_(or__6059__auto__)){
return or__6059__auto__;
} else {
...
var temp__4657__auto___13207 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___13207)){
var message_13208 = temp__4657__auto___13207;
cljs.core.println.call(null,message_13208);
} else {
}
...
var temp__4657__auto___13209 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__4657__auto___13209)){
var message_13210 = temp__4657__auto___13209;
cljs.core.println.call(null,message_13210);
} else {
}
...
var temp__4655__auto__ = (function (){var and__6047__auto__ = typeof exception.stack === 'string';
if(and__6047__auto__){
var G__13220 = exception.stack;
var G__13220__$1 = (((G__13220 == null))?null:clojure.string.split_lines.call(null,G__13220));
var G__13220__$2 = (((G__13220__$1 == null))?null:cljs.core.get.call(null,G__13220__$1,depth));
if((G__13220__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__13220__$2);
}
} else {
...
var vec__13221 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__13221,(0),null);
var column = cljs.core.nth.call(null,vec__13221,(1),null);
var vec__13224 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__13224,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__13224,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__13224,(2),null);
...
var m__$1 = (function (){var G__13228 = (((new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m).fqn:null);
switch (G__13228) {
case "fail":
...
var G__13234 = (function (){var G__13233 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__13233);
} else {
return G__13233;
}
})();
...
return cljs.core.vary_meta.call(null,G__13236,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
}catch (e13239){var e = e13239;
var G__13240 = (((e instanceof cljs.core.Keyword))?e.fqn:null);
switch (G__13240) {
...
var vec__13245 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__13245,(0),null);
var types = vec__13245;
...
return cljs.core.map.call(null,(function (p__13257){
var vec__13258 = p__13257;
var ns = cljs.core.nth.call(null,vec__13258,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__13258,(1),null);
return ((function (vec__13258,ns,vars__$1){
return (function (){
...
var G__13261 = (((cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures) instanceof cljs.core.Keyword))?cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures).fqn:null);
switch (G__13261) {
case "async":
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1){
return (function (){
var seq__13262 = cljs.core.seq.call(null,vars__$1);
var chunk__13263 = null;
var count__13264 = (0);
var i__13265 = (0);
while(true){
if((i__13265 < count__13264)){
var v = cljs.core._nth.call(null,chunk__13263,i__13265);
var temp__4657__auto___13267 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___13267)){
var t_13268 = temp__4657__auto___13267;
each_fixture_fn.call(null,((function (seq__13262,chunk__13263,count__13264,i__13265,t_13268,temp__4657__auto___13267,v,each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13268)));
});})(seq__13262,chunk__13263,count__13264,i__13265,t_13268,temp__4657__auto___13267,v,each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1))
);
} else {
}

var G__13269 = seq__13262;
var G__13270 = chunk__13263;
var G__13271 = count__13264;
var G__13272 = (i__13265 + (1));
seq__13262 = G__13269;
chunk__13263 = G__13270;
count__13264 = G__13271;
i__13265 = G__13272;
continue;
} else {
var temp__4657__auto__ = cljs.core.seq.call(null,seq__13262);
if(temp__4657__auto__){
var seq__13262__$1 = temp__4657__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__13262__$1)){
var c__6870__auto__ = cljs.core.chunk_first.call(null,seq__13262__$1);
var G__13273 = cljs.core.chunk_rest.call(null,seq__13262__$1);
var G__13274 = c__6870__auto__;
var G__13275 = cljs.core.count.call(null,c__6870__auto__);
var G__13276 = (0);
seq__13262 = G__13273;
chunk__13263 = G__13274;
count__13264 = G__13275;
i__13265 = G__13276;
continue;
} else {
var v = cljs.core.first.call(null,seq__13262__$1);
var temp__4657__auto___13277__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__4657__auto___13277__$1)){
var t_13278 = temp__4657__auto___13277__$1;
each_fixture_fn.call(null,((function (seq__13262,chunk__13263,count__13264,i__13265,t_13278,temp__4657__auto___13277__$1,v,seq__13262__$1,temp__4657__auto__,each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_13278)));
});})(seq__13262,chunk__13263,count__13264,i__13265,t_13278,temp__4657__auto___13277__$1,v,seq__13262__$1,temp__4657__auto__,each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1))
);
} else {
}

var G__13279 = cljs.core.next.call(null,seq__13262__$1);
var G__13280 = null;
var G__13281 = (0);
var G__13282 = (0);
seq__13262 = G__13279;
chunk__13263 = G__13280;
count__13264 = G__13281;
i__13265 = G__13282;
continue;
}
} else {
...
});})(each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1))
);
});})(each_fixture_fn,G__13261,env,once_fixtures,each_fixtures,vec__13258,ns,vars__$1))
], null);
